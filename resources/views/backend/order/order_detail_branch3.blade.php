                        ...
                        <tr>
                            ...
                            <th>
                                @if ($order->status == 'Pending')
                                    <a href="{{route('pendingToConfirmed_branch3', $order->id)}}" class="btn btn-block btn-success" id="confirm">Confirm Order</a>
                                
                                @elseif ($order->status == 'Confirmed')
                                    <a href="{{route('ConfirmedToProcessing_branch3', $order->id)}}" class="btn btn-block btn-success" id="processing">Processing Order</a>
                                @elseif ($order->status == 'Processing')
                                    <a href="{{route('ProcessingToArrived_branch3', $order->id)}}" class="btn btn-block btn-success" id="picked">Arrived Order</a>
                                @elseif ($order->status == 'Arrived')
                                    <a href="{{route('ArrivedToPicked_branch3', $order->id)}}" class="btn btn-block btn-success" id="picked">Pick Order</a>
                                @endif
                            </th>
                        </tr>
                            ...
                            <tr>
                                ...
                                @if ($order->status == 'Pending')
                                    <td>
                                        ...
                                        <a href="{{route('edit_admin_branch3', $item->id)}}" class="btn btn-info" title="Edit Data" ><i class="fa fa-pencil"></i> </a>
                                    </td>
                                @endif
                            </tr>
